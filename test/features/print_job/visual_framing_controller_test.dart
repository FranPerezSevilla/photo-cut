...
void main() {
  test('visual focus reuses crop state and survives fit-mode round trips', () async {
    final PrintConfigurationController controller = PrintConfigurationController(
      image: SelectedImage(
    ...
    final NormalizedCropRect cropped = controller.state.configuration.cropRect;
