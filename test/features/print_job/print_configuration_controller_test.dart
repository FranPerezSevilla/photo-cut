...
void main() {
  test('defaults become reviewable after orientation-aware inspection', () async {
  ...
  test('fit, colour and focus update immutable document configuration', () async {
    final PrintConfigurationController controller =
        PrintConfigurationController(
          image: _image(),
          imageProcessor: _FakeImageProcessor(
  ...
  test('target size changes recalculate the normalized crop rectangle', () async {
    final PrintConfigurationController controller =
        PrintConfigurationController(
          image: _image(),
          imageProcessor: _FakeImageProcessor(
    ...
    await controller.inspectImage();
    final NormalizedCropRect original = controller.state.configuration.cropRect;
