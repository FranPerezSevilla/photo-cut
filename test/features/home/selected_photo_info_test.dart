...
void main() {
  testWidgets('shows concise pixels and photographic-size guidance', (
    WidgetTester tester,
  ) async {
    ...
    expect(find.textContaining('calidad fotográfica'), findsOneWidget);
    expect(find.textContaining('600 ppp'), findsNothing);
  });
}
