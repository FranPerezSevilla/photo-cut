...
void main() {
  ...
  test('inspection bakes EXIF orientation before reporting dimensions', () async {
    final Uint8List bytes = base64Decode(
      File(
        'test_resources/exif-orientation-6.jpg.base64',
  ...
  test('fit-inside preserves the oriented source aspect without distortion', () async {
    final Uint8List source = _solidPng(
      width: 400,
      height: 200,
      red: 30,
  ...
  test('grayscale is applied to exported image bytes inside Photo Cut', () async {
    final Uint8List source = _solidPng(
      width: 20,
      height: 20,
      red: 240,
