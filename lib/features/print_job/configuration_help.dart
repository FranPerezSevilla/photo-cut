...
_configurationHelp = <ConfigurationHelpTopic, ConfigurationHelpContent>{
  ConfigurationHelpTopic.fitMode: ConfigurationHelpContent(
    ...
    whenToUse: 'Usa Rellenar si quieres ocupar toda la foto impresa. Usa Encajar si prefieres conservar la imagen completa.',
    example: 'Una foto panorámica en 35 × 45 mm: Rellenar recorta los lados; Encajar mantiene todo y puede dejar bordes blancos.',
    documentImpact:
        'Cambia el contenido del PDF, pero no el tamaño físico elegido.',
  ),
  ConfigurationHelpTopic.framing: ConfigurationHelpContent(
    title: 'Encuadre',
    whatItDoes: 'Elige qué zona de la imagen se conserva cuando Rellenar necesita recortar.',
    whenToUse: 'Ajústalo si una cara, un objeto o una parte importante queda demasiado cerca del borde o fuera de la foto.',
    example: 'Si la persona está a la derecha, mueve el encuadre hacia la derecha para conservarla dentro del recorte.',
  ...
  ConfigurationHelpTopic.colorMode: ConfigurationHelpContent(
    ...
    whatItDoes: 'Decide si Photo Cut mantiene los colores originales o convierte la imagen a escala de grises.',
    whenToUse: 'Elige blanco y negro cuando quieras que el propio PDF quede ya preparado sin depender de la impresora.',
    example: 'Seleccionar Blanco y negro hace que la vista previa y el PDF final se generen en grises.',
    documentImpact:
        'Cambia los píxeles del PDF antes de abrir la impresión del sistema.',
  ),
  ...
  ConfigurationHelpTopic.unit: ConfigurationHelpContent(
    ...
    whatItDoes:
        'Cambia cómo introduces y ves ancho, alto, margen y separación.',
    ...
    documentImpact: 'No cambia el tamaño por sí sola: Photo Cut conserva la misma medida física al cambiar de unidad.',
  ),
  ConfigurationHelpTopic.paper: ConfigurationHelpContent(
    title: 'Tamaño del papel',
    whatItDoes:
        'Define el tamaño de la hoja del PDF donde se colocan las copias.',
  ...
  ConfigurationHelpTopic.margin: ConfigurationHelpContent(
    title: 'Margen',
    whatItDoes:
        'Reserva una distancia mínima entre las copias y el borde del papel.',
    whenToUse: 'Normalmente puedes dejar el valor por defecto. Auméntalo si tu impresora no puede imprimir cerca de los bordes.',
  ...
  ConfigurationHelpTopic.gap: ConfigurationHelpContent(
    ...
    whenToUse: 'Normalmente puedes dejar el valor por defecto. Auméntalo si quieres más espacio para cortar.',
  ...
  ConfigurationHelpTopic.cutMarks: ConfigurationHelpContent(
    ...
    whatItDoes:
        'Añade guías finas alrededor de cada copia para facilitar el recorte.',
    whenToUse:
        'Actívalas si vas a cortar las fotos manualmente después de imprimir.',
    example: 'Las líneas indican por dónde cortar sin cambiar los 35 × 45 mm de la foto.',
    documentImpact:
        'Añade guías al PDF sin cambiar el tamaño exterior de cada copia.',
  ),
};
...
Future<void> _showHelp(BuildContext context, ConfigurationHelpContent content) {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              _HelpSection(
                title: 'En el documento',
                body: content.documentImpact,
              ),
