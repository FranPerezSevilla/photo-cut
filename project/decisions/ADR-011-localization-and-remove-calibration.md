...
- Follow the operating-system locale by default. If the user chooses a language manually in the app, that override wins for the current app session; choosing “System” returns to OS locale resolution.
